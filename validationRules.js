...
},
{
  ...
  config: {"structural":["Component","Package","Logical"],"behavioral":["Sequence","State","Activity","Use Case"]},
  ID: "ASR5",
  diagram: function (diagram) { this.findings.push(diagram.Type) },
  result: function () {
  		...
  		for (var i in this.findings) {
  			...
  			if (hasBehavioral && hasStructural) return {success: true, messages: []}
  		}
  		return {success: false, messages: ["Model has no " + 
...
},
{
  ...
  element: function (element){this._auxiliary(element, element.Type)},
  package: function (package){this._auxiliary(package.Element, "Package")}
},
{
...
},
{
  ...
  config: {"techName":"Mega","requiredVersion":"1"},
  ID: "ASR8",
  result: function (){
...
},
{
  ...
  ID: "ASR9",
  config: {"Component":["Port","Component"],"Activity":["StateNode","Activity"]},
  diagram: function (diagram) {
